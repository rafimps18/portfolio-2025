...
<section id="about-me">
	<div class="flex min-h-screen w-screen flex-col items-center justify-start px-4 py-12 md:px-12">
		<div class="mb-5 border-b-4 border-(--blue-primary) lg:mb-0">
		...
		>
			...
			<div
				class="flex h-fit w-screen items-center justify-center bg-radial-[at_50%_60%] from-purple-300 to-black to-70% py-2 lg:w-[50%] lg:to-60%"
			>
				<img
					src="/pic.jfif"
					class="h-[30vh] rounded-2xl lg:h-[40vh]"
					alt="graduation pic of me"
					loading="lazy"
				/>
			</div>
		</div>
